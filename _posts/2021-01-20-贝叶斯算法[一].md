...
然后又收到了第9份简历，他的学历情况是：硕士、普本院校，求他被录用的概率。
...
![htdiY.jpg](https://s.im5i.com/2021/01/27/htdiY.jpg)
...
拉普拉斯平滑也叫加一平滑，专门解决0概率问题，它的操作非常简单，就是直接把每个类别里所有划分的情况计数**加1**，只要数据集足够大，对最终结果产生的影响可以忽略。公式如下：
