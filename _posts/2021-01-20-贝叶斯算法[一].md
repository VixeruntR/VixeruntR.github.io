...
打印的第一个列表是词汇表，第二个列表是词汇表中每个单词不具有攻击性的概率，第三个列表是词汇表中每个单词具有攻击性的概率。例如`dog`这个单词，根据打印结果可知该单词不具有攻击性的概率为`0.083`，具有攻击性的概率为`0.105`；以及`cute`这个单词，根据打印结果可知该单词不具有攻击性的概率为`0.041`，具有攻击性的概率为`0.000`。
