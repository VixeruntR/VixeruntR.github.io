...
+ 对于多线程而言，`ThreadPoolExecutor` 让多线程的使用更加方便，减小了线程创建/销毁的资源消耗，**自动调度线程，无需考虑线程间的复杂同步**，方便主线程与子线程的交互。
  ...
  这里仍然以第一篇文章中的例子[线程锁](https://vixeruntr.github.io/2020/12/10/%E5%A4%9A%E7%BA%BF%E7%A8%8B&%E5%A4%9A%E8%BF%9B%E7%A8%8B(%E4%B8%80)/)的代码为例，在不加锁的情况下会出现共享资源的调度错误，这里使用`ThreadPoolExecutor` 创建多线程执行该任务：
